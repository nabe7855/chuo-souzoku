...
const IconInputRow: React.FC<{
  ...
  <div className="flex items-center gap-3">
    <div className="w-10 h-10 flex-shrink-0 flex items-center justify-center text-navy bg-navy/10 rounded-lg">
      {icon}
    </div>
    <label htmlFor={name} className="flex-1 text-gray-700 font-medium">
      {label}
    </label>
...
const SimulatorSection: React.FC = () => {
  ...
  const calculateTax = () => {
    ...
    const getTaxForShare = (share: number): number => {
      if (share <= 10_000_000) return share * 0.1;
      if (share <= 30_000_000) return share * 0.15 - 500_000;
      if (share <= 50_000_000) return share * 0.2 - 2_000_000;
      if (share <= 100_000_000) return share * 0.3 - 7_000_000;
      if (share <= 200_000_000) return share * 0.4 - 17_000_000;
      if (share <= 300_000_000) return share * 0.45 - 27_000_000;
      if (share <= 600_000_000) return share * 0.5 - 42_000_000;
  ...
  return (
    <section id="simulator" className="py-16 md:py-24 bg-white">
      ...
      <div className="container mx-auto px-6">
        <SectionTitle
          title="かんたん相続税シミュレーター"
          subtitle="Tax Simulation"
        />
        <Card>
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-start">
            ...
            <div className="space-y-6">
              ...
              <div>
                <h3 className="font-bold text-xl text-navy mb-4 flex items-center gap-2">
                  <Users size={24} />
                  法定相続人
                </h3>
                <div className="space-y-3">
                        ...
                        <>
                          ...
                          <p className="text-4xl md:text-5xl font-bold text-gold-dark my-1">
                            ...
                            <span className="text-6xl md:text-7xl">
                              {(taxAmount / 10000).toLocaleString()}
                            </span>{" "}
                            万円
                          </p>
                        </>
