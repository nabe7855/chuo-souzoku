          ...
          <div className="flex gap-2">
            <div className="relative flex-1">
              <input
                ...
                placeholder="例: 2"
                className="w-full border-2 border-gray-300 rounded-xl px-4 py-3 pr-12 focus:outline-none focus:border-[var(--color-navy)] focus:ring-[var(--color-navy)] transition text-lg"
                autoFocus
                inputMode="numeric"
              />
