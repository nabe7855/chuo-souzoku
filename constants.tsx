...
import type { Plan, Review, FAQItem, ServiceItem, TeamMember } from './types';
import { Scale, Users, Handshake, Landmark, Briefcase, FileText, Bot } from 'lucide-react';
...
export const PLANS: Plan[] = [
  ...
  },
  {
    ...
    features: ['ライトプランの全内容', '不動産の名義変更（登記）', '預貯金・株式等の解約・名義変更', '各種行政手続き代行'],
    isStandard: true,
  },
  {
    name: 'プレミアムプラン',
    ...
    features: ['スタンダードプランの全内容', '二次相続コンサルティング', '海外資産の相続手続き支援', '税務申告サポート（提携税理士）']
  }
];

export const REVIEWS: Review[] = [
  {
    quote: '何から手をつけて良いか分からなかったのですが、全てお任せできて本当に助かりました。',
    author: '佐藤様',
    details: '70代・スタンダードプラン',
    rating: 5,
  },
  {
    quote: '料金が明確で、追加費用も一切なく安心でした。説明も非常に丁寧で分かりやすかったです。',
    author: '鈴木様',
    details: '60代・スタンダードプラン',
    rating: 5,
  },
  {
    quote: '遠方に住んでいるため非対面での手続きに不安がありましたが、LINEや郵送でスムーズに進めて頂けました。',
    author: '高橋様',
    details: '50代・ライトプラン',
    rating: 4,
  }
...
export const FAQS: FAQItem[] = [
  {
    question: '本当に33万円で全ての手続きが終わりますか？追加費用はかかりませんか？',
    answer: 'はい、スタンダードプランは税込33万円の定額です。戸籍謄本取得などの実費以外、当事務所への報酬として追加費用は一切発生しませんのでご安心ください。'
  },
  {
    question: '地方に住んでいますが、依頼は可能ですか？',
    answer: 'はい、全国対応しております。Zoom、LINE、お電話、郵送などを活用し、一度もご来所いただくことなく全ての手続きを完結させることが可能です。'
  },
  {
    question: '相談だけでも大丈夫ですか？',
    answer: 'もちろんです。初回のご相談は無料ですので、まずはお気軽にお悩みをお聞かせください。無理な勧誘は一切行いません。'
  },
  {
    question: '支払方法は何がありますか？',
    answer: '銀行振込とクレジットカード払いに対応しております。分割払いのご相談も承りますので、お気軽にお申し付けください。'
  }
];
